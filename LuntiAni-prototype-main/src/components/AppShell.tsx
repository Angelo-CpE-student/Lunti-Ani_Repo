  ...
  return (
    <div className="min-h-dvh flex flex-col md:flex-row">
      ...
      <aside className="hidden md:flex md:w-60 md:flex-col md:shrink-0 bg-field text-white p-6">
        <div className="flex flex-col items-start text-left" style={{ fontFamily: '"Cardo", serif' }}>
          <div className="flex items-center gap-2 text-xl font-semibold">
            <img src={LOGO_IMAGE} alt="LuntiAni logo" className="h-10 w-10 rounded-full object-cover ring-1 ring-white/60" />
            <span style={{ color: '#f6f3f0' }}>
              Lunti
              <span style={{ color: '#c79c2d' }}>A</span>
              ni
            </span>
          </div>
          {user && <p className="mt-1 pl-[3rem] text-sm leading-5 text-white/70">{user.farm.name}</p>}
        </div>
