    ...
    <AppShell>
      <div className="mx-auto max-w-2xl px-5 pb-10 md:px-8">
        ...
        <section className="mt-6">
          <h2 className="font-display text-lg font-semibold text-ink">SMS preview</h2>
          <Card className="mt-3">
            <button
            ...
            >
              <MessageIcon size={18} />
              Preview HIGH-risk SMS
            </button>
            <p className="mt-2 text-xs text-ink-soft">Preview only. No real SMS will be sent.</p>
          </Card>
        </section>
